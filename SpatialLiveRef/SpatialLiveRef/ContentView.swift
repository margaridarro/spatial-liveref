        ...
        VStack {
            ...
            RealityView { content in
                ...
                for _ in file_list {
                    ...
                    let entity = FileBuildingEntity(resourceName: "BuildingSceneYellow", fileName: "String", filePath: "String", loc: 0, nom: 0, numberRefactorings: 0, refactorings: [Refactoring(refactoringType: RefactoringType.ExtractMethod, methodName: "", elements: 0, severity: 0, locToChange: 0, className: "")])
