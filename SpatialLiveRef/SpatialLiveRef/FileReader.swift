...
func getProjectFiles (file_path : String, refactorings_path : String) -> ([[String]], [[String]]) {
    ...
    */
    ...
    // RX Java project
    let file_path = "projects/RxJava/Prints/files.txt"
    let refactorings_path = "projects/RxJava/Prints/refactorings.txt"
    ...
    if let dir = FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first {
        ...
        let fileURL = dir.appendingPathComponent(file_path)
        ...
        let refactorings_fileURL = dir.appendingPathComponent(refactorings_path)
        
        do {
            let text_refactorings = try String(contentsOf: refactorings_fileURL, encoding: .utf8)
